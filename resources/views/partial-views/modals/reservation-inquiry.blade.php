<x-modal element-name="reservation-inquiry-modal" size="lg">
    ...
    <div class="row">
        <div class="col-md-5">
            <div class="d-flex justify-content-between">
                <div class="d-flex flex-column align-items-start px-3 py-1">
                    ...
                    <h2 class="text--dark-green fw--bold fs--large mb-2 my-3">Check Availability</h2>
        ...
        <div class="col-md-7">
            @include(
                'partial-views.forms.reservation-inquiry', [
                    "submit_route" => route('guest.inquiries.request.submit')
                ]
            )
        </div>
      </div>
...
<!-- Modal -->
{{-- <div class="modal fade" id="reservation-inquiry-modal" tabindex="-1" aria-labelledby="reservation-inquiry-modalLabel" aria-hidden="true">
