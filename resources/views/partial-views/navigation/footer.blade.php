<div class="container">
    <footer class="footer mt-auto pt-5 pb-2">
      <div class="row">
        ...
        <div class="col-2">
          <h5 class="text-white mb-2">Social Media</h5>
          <ul class="list-unstyled d-flex py-3">
            <li>
              <a class="link-dark" href="#">
                <img src="{{ asset('dist/images/icons/facebook-ic.svg') }}" alt="facebook-logo">
              </a>
            </li>
            <li class="ms-3">
              <a class="link-dark" href="#">
                <img src="{{ asset('dist/images/icons/instagram-ic.svg') }}" alt="instagram-logo">
              </a>
            </li>
            <li class="ms-3">
              <a class="link-dark" href="#">
                <img src="{{ asset('dist/images/icons/twitter-ic.svg') }}" alt="twitter-logo">
              </a>
            </li>
            <li class="ms-3">
              <a class="link-dark" href="#">
                <img src="{{ asset('dist/images/icons/youtube-ic.svg') }}" alt="youtube-logo">
              </a>
            </li>
          </ul>
        </div>
        <div class="col-4">
          <form>
            <h5 class="text-white mb-2 pb-3">Subscribe to our newsletter</h5>
            <small class="text-white">Monthly digest of whats new and exciting from us.</small>
