        ...
        <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <img src="{{ asset('dist/images/slider-1.jpg') }}" class="mt-5" alt=""
                ...
                <div class="row py-5">
                    ...
                    <div class="col-md-6">
                        <div class="d-flex flex-column align-items-start">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sapien augue sit orci, vestibulum
                                nulla.
                                Eu cras augue mi,
                                sed molestie cursus sed. Habitasse vel nibh id consectetur sed est sollicitudin. Dui
                                faucibus
                                metus, suspendisse non.
                                Accumsan volutpat odio vulputate aliquam, non. Amet proin commodo vitae tincidunt eget
                                mauris
                                sit. Dui pulvinar nullam
                                arcu duis. Nisl, risus, pellentesque facilisis sem quam viverra aenean et. Nec eros
                                scelerisque
                                elit id aliquam, et.
